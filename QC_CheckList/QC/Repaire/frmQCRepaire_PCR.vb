...
#Region "Sync data all"
    ...
    Private Sub LoadDataRepaire(Optional ByVal _BackRequest As Boolean = False)
        ...
        'mainVar._loadData = Sub() If (Not _BackRequest) Then _objBLLQCRepair.SyncPCRData_Repaire(_dtStart, _dtEnd, _classSelect, _codetypeSelect)
        mainVar._loadData = Sub() If (Not _BackRequest) Then _objBLLQCRepair.SyncPCRData_Repaire(_dtStart, _dtEnd, _classSelect)
