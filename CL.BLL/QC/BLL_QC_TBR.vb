...
Public Class BLL_QC_TBR : Inherits DBAccess
    ...
    Public Function Get_QC1_TBRWorked(ByVal _filter As QC1_GETFILTER, ByVal dtStart As DateTime, ByVal dtEnd As DateTime) As List(Of String)
        ...
        Dim _SQLPHASEFILTER As String = If(Phase = "A", "BETWEEN 99 AND 99", "BETWEEN 5 AND 6")
    ...
    Public Function Get_QC1_TBRWorked_TBRResult(ByVal _filter As QC1_GETFILTER, ByVal keyID As String, ByVal dtStart As DateTime, ByVal dtEnd As DateTime) As List(Of QC1_Graphsummary)
        Dim _dtTbl As New DataTable
        ...
        Using _sqlAdp As New SqlDataAdapter(_SQLCMD, DBAccess(CONNECT_TARGET.DB27))
            ...
            If (_dtTbl.Rows.Count > 0) Then
                ...
                With _WorkInfo
                    ...
                    .EMPACT_Px = _dtTbl.Select("CLASS IN ('P','P0','TEST','TEST BS','NG')").Count
    ...
    Public Function Get_QC1_TBRWorkedView(ByVal dtStart As DateTime, ByVal dtEnd As DateTime) As DataTable
        Dim _dtTbl As New DataTable
    ...
    Public Function ExportSumTBRGraphReport(ByVal _bitmap As System.Drawing.Bitmap, ByVal _pathToExport As String) As Boolean
        ...
        Try
            ...
            With excelSheet
                ...
                .Range("A1").Value2 = String.Format("Export summary TBR Phase {0} at Date {1}", Phase, GetDate_Server.ToString("dd/MM/yyyy HH:mm:ss"))
                .Range("A3").Select()
    ...
    End Function
    Public Function ExportSumTBRDataViewReport(ByVal _DataView As System.Windows.Forms.DataGridView, ByVal _pathToExport As String) As Boolean
